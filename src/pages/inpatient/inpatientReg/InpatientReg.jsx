...
const Patient = () => {
  ...
  useEffect(()=>{
    setCurrentPage("In-Patient Registeration ") ;
    setMenuPage(false) ; 
  },[])
  ...
  return (
    <div >
            ...
            <div><p>ward</p><input type="text" onChange={e => setWard(e.target.value)} value={ward} /></div>
            <div><p>room No</p><input type="text" onChange={e => setRoomNo(e.target.value)} value={roomNo} /></div>
            </div>
            <div>
            <div className='calendar-wrapper'>
              <p>Date and Time </p>
